...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#f0f1f3] dark:bg-slate-900 w-full border-t border-slate-200 dark:border-slate-800">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 px-8 py-16 max-w-screen-2xl mx-auto">
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            <a 
              href="https://www.facebook.com/share_channel/?type=reshare&link=https%3A%2F%2Fkidscareeracademy.in%2F&app_id=966242223397117&source_surface=external_reshare&display&hashtag#" 
              target="_blank" 
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-[#3b5998] text-white flex items-center justify-center hover:scale-110 transition-transform shadow-md shadow-[#3b5998]/30" 
              title="Facebook"
            >
            ...
            <a 
              href="https://api.whatsapp.com/send?text=**%0A%0Ahttps://kidscareeracademy.in/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-[#25D366] text-white flex items-center justify-center hover:scale-110 transition-transform shadow-md shadow-[#25D366]/30" 
              title="WhatsApp"
            >
            ...
            <a 
              href="https://telegram.me/share/url?url=https://kidscareeracademy.in/&text=" 
              target="_blank" 
              rel="noopener noreferrer"
              className="w-10 h-10 rounded-full bg-[#0088cc] text-white flex items-center justify-center hover:scale-110 transition-transform shadow-md shadow-[#0088cc]/30" 
              title="Telegram"
            >
            ...
            <a 
              href="mailto:KIdscareeracadamy@gmail.com" 
              className="w-10 h-10 rounded-full bg-[#ea4335] text-white flex items-center justify-center hover:scale-110 transition-transform shadow-md shadow-[#ea4335]/30" 
              title="Email"
            >
        ...
        <div>
          ...
          <ul className="space-y-4 text-slate-500 text-sm">
            <li><Link href="/program/cbdp" className="hover:text-primary transition-all">CBDP</Link></li>
            <li><Link href="/program/communicative-english" className="hover:text-primary transition-all">Communicative English</Link></li>
            <li><Link href="/program/creative-arts" className="hover:text-primary transition-all">Creative Arts</Link></li>
            <li><Link href="/program/abacus" className="hover:text-primary transition-all">Abacus</Link></li>
            <li><Link href="/program/vedic-maths" className="hover:text-primary transition-all">Vedic Maths</Link></li>
            <li><Link href="/program/aip" className="hover:text-primary transition-all">AIP</Link></li>
            <li><Link href="/program/seep" className="hover:text-primary transition-all">SEEP</Link></li>
            <li><Link href="/program/feep" className="hover:text-primary transition-all">FEEP</Link></li>
            <li><Link href="/program/robotics-ai" className="hover:text-primary transition-all">Robotics & AI</Link></li>
          </ul>
        </div>
